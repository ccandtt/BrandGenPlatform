...
{
  "task": "logo",
  "prompt": "为餐饮行业设计logo的中文文生图提示词。\n品牌名称：糖乐。\n风格：极简、温暖。\n元素/关键词：甜品、笑脸。\n结合以下知识增强：\n[KB filters] industry=餐饮, task=logo, style=*\n[模板]\n- 极简扁平风格，强调识别度与品牌温度，图形与文字比例均衡。\n[规则与约束]\n- 优先使用简洁几何形，确保在小尺寸下仍清晰可辨。\n[配色]\n- 暖橙、奶油白、浅咖色为主，少量深棕作为对比。\n[字体]\n- 中文采用圆角黑体或手写感字形，保持亲和与可读性。\n[图形元素]\n- 可选用勺子、碗、蒸汽等图形元素表现食物温度感。\n[避坑/禁忌]\n- 避免复杂纹理与过度写实食物特写，影响识别性。",
